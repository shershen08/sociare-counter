...
describe('Counter', () => {
    ...
    describe('getCounts', () => {
        ...
        beforeEach(() => {
            ...
            pinterest = sinon.stub(counter.pinterest, 'getCount', () => Promise.resolve(2));
            linkedin = sinon.stub(counter.linkedin, 'getCount', () => Promise.resolve(3));
            googleplus = sinon.stub(counter.googleplus, 'getCount', () => Promise.resolve(4));
        });
        ...
        it('should get counts for the url provided from each network provided', () => {
            return counter.getCounts(url, { networks: ['facebook'] })
                .then(counts => {
